...
use Modules\{module}\Repository\DummyRepository;
use Navel\Laravel\Modular\Providers\ServiceProvider as BaseServiceProvider;
...
class ServiceProvider extends BaseServiceProvider
{
    ...
    public function boot()
    {
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/../resources/views' => resource_path('views/vendor/{moduleName}'),
        ], 'module.{moduleName}.views');
